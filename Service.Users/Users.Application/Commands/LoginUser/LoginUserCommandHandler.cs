...
namespace Users.Application.Commands.LoginUser
{
    ...
    {
        private readonly IUserRepository _userCredentialsRepository;
        private readonly IJwtService _jwtService;

        public LoginUserCommandHandler(IUserRepository userCredentialsRepository, IJwtService jwtService)
        {
