...
{
    public class GetBookingsByDateQueryHandler 
        : IRequestHandler<GetBookingsByDateQuery, Result<IEnumerable<BookingViewModel>>>
    {
        private readonly IBookingRepository _bookingRepository;
        private readonly IConferenceHallService _сonferenceHallService;
        private readonly IMapper _mapper;

        public GetBookingsByDateQueryHandler(
        ...
        public async Task<Result<IEnumerable<BookingViewModel>>> Handle(
            GetBookingsByDateQuery request, 
            CancellationToken cancellationToken
        )
        {
            var getBookingsResult = await _bookingRepository.GetByDateAsync(request.Date);
            ...
            {
                return Result.Failure<IEnumerable<BookingViewModel>>("No bookings were found for the specified date");
            }
